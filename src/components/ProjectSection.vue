...
.rl { font-family: var(--ff-mono); font-size: 10px; font-weight: 500; text-transform: uppercase; letter-spacing: .1em; color: var(--txt-4); margin-bottom: .85rem; }
.tags { display: flex; flex-wrap: wrap; gap: 7px; margin-bottom: 2rem; }
.tech {
...
.arch li { font-size: 12.5px; color: var(--txt-3); line-height: 1.6; padding-left: 1rem; position: relative; }
